<div class="container" style="min-height: calc(100vh - 157px)">
    ...
    <section class="section">
        <!--Section heading-->
        <h2 class="h1-responsive font-weight-bold text-center my-5">Modifier "<?= $recipe->getName() ?>"</h2>
        <!--Section description-->
        <p class="text-center w-responsive mx-auto mb-5">Modifier votre recette uniquement pour y apporter des améliorations, vérifiez l'orthographe avant de la mettre en ligne.<br>Soyez clair, précis et concis.</p>
        <?php include 'views/assets/alert.php'; ?>
        <div class="row">

            <!--Grid column-->
            <div class="col-md-12 mb-md-0 mb-5">
                <form id="editrecipe" name="editrecipe" method="post" enctype="multipart/form-data" action="/recipe/<?=$recipe->getId()?>/edit/proceed">

                    <!--Grid row-->
                    <div class="row">
                        <div class="col-md-5">
                            <div class="md-form mb-0">
                                <input type="text" id="name" name="name" class="form-control" value="<?= $recipe->getName() ?>">
                                <label for="name" class="">Nom de votre recette</label>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="md-form mb-0">
                                <input type="number" id="nbPers" name="nbPers" class="form-control" value="<?= $recipe->getNbPers() ?>">
                        ...
                        <div style="padding-top: 40px" class="col-md-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <input type="checkbox" class="custom-control-input" id="status" name="status" value="private" <?php if($recipe->getStatus() == "private") { echo 'checked'; } ?>>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="md-form mb-0">
                                <input type="text" id="shortDesc" name="shortDesc" class="form-control" value="<?= $recipe->getShortDesc() ?>">
                                <label for="shortDesc" class="">Courte déscription</label>
                            </div>
                        </div>
                    </div>
                    <!--Grid row-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="md-form">
                                <textarea type="text" id="longDesc" name="longDesc" rows="2" class="form-control md-textarea"><?= $recipe->getLongDesc() ?></textarea>
                    ...
                    <!--Grid row-->
                    <input type="hidden" name="oldimg" id="oldimg" value="<?= $recipe->getImg() ?>">
                    <input type="hidden" name="oldingredients" id="oldingredients" value="<?= $stringredients ?>">
                    <input type="hidden" name="oldsteps" id="oldsteps" value="<?= $recipe->getSteps()?>">
                    ...
                    <div class="text-center text-md-center">
                        <?php if ($recipe->getStatus() == "draft") {?>
                        <a class="btn btn-primary" onclick="save_edit()">Sauvegarder</a>
                        <a class="btn btn-primary" onclick="publish_edit()">Publier</a>
                        <?php } else { ?>
                        <a class="btn btn-primary" onclick="publish_edit()">Sauvegarder</a>
                        <?php } ?>
                    </div>
                </form>
...
<div class="modal fade" id="modaladdingredient" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="previousurl" id="previousurl" value="/recipe/<?= $recipe->getId()?>/edit">
            </form>
        </div>
    </div>
</div>